...
# Home Function
def Home():
    print("\t\t\t\t\t\t WELCOME TO HOSTEL GIGGLE GROUNDS\n")
    print("\t\t\t 1 Booking\n")
    print("\t\t\t 2 Rooms Info\n")
    print("\t\t\t 3 Payment\n")
    print("\t\t\t 4 Record\n")
...
def Rooms_Info():
    ...
    print("Double-Door Cupboard, 1 table and chair, Balcony and")
    ...
    print("3-Bed NON-AC")
    print("---------------------------------------------------------------")
    print("Room amenities include: 3 Single Bed")
    print("a Triple-Door Cupboard, 3 table and chair")
    print("Balcony and an")
    ...
    for n in range(0, i):
        if ph == phno[n]:
            ...
            if p[n] == 0:
                ...
                print("\n            Pay For GIGGLE GROUNDS")
                print("  (y/n)")
                ch = str(input("->"))

                if ch == 'y' or ch == 'Y':
                    print("\n\n --------------------------------")
                    print("           Hostel Giggle Grounds")
                    print(" --------------------------------")
                    print("              Bill")
                    print(" --------------------------------")
                    print(" Name: ", name[n], "\t\n Phone No.: ", phno[n], "\t\n Address: ", add[n], "\t")
